...
const GlobeIcon = ({ width = 18, height = 18 }) => (
...
function App() {
  ...
  return (
    <div className="container">
        ...
        <ul className="dropdown-menu">
          {
            languages.map(({ code, name }) => (
              <li key="code"><button className="dropdown-item"
      ...
      <div className=".d-flex.flex-oclumn.align-items-start">
        <h2 className="font-weight-normal mb-3">{t('welcome_to_react')}</h2>
